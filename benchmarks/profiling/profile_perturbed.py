...
radius = 0.5
eps_m = 2.13
omega = np.linspace(1000, 7000, 2) # Reduced to 2 wavenumbers for profiling efficiency
...
Nx, Ny, Nz = 40, 40, 40
N = Nx * Ny * Nz  # 64,000 particles

print(f"Setting up 3D perturbed lattice profile with {N} particles (2 wavenumbers)...")
